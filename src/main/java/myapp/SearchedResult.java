 ...
 * @author rahul
 */
public class SearchedResult extends HttpServlet {
  ...
  /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String data=request.getParameter("GameName");
           ...
           Iterator itr=al.iterator();
            ...
            if(c>0)
            { RequestDispatcher rd=request.getRequestDispatcher("SearchedGame.jsp");
